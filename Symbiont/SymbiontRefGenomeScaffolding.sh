#!/bin/bash
#SBATCH -J SymbiontRefGenomeScaffolding
#SBATCH -t 100:00:00
#SBATCH -n 24
#SBATCH -N 1
#SBATCH --mem=200g
#SBATCH -o SymbiontRefGenomeScaffolding.out
#SBATCH -e SymbiontRefGenomeScaffolding.err
...
#Example for the A. boucheti Epsilon symbiont
